    ...
    public String addQuestion(@RequestParam("title") String title,
        ...
        try{
            ...
            if(questionService.addQuestion(question) >0){
                eventProducer.fireEvent(new EventModel(EventType.ADD_QUESTION).setEntityType(EntityType.ENTITY_QUESTION).setEntityId(question.getId())
                        .setActionId(question.getUserId())
                        .setExts("question_title",question.getTitle()).setExts("question_content",question.getContent()));
