...
public class BineryTree<K,V> {
    ...
    private <K extends Comparable> BinaryTreeNode insert(BinaryTreeNode r, K key, V value){
        if(r == null){
            count++;
    ...
    private <K extends Comparable> boolean contains(BinaryTreeNode ro, K key){
    ...
    public <K> BinaryTreeNode minimum(){
        if(root!=null)
            return minimum(root);
        else throw new IllegalArgumentException("空树");
    }
    private <K> BinaryTreeNode minimum(BinaryTreeNode n){
        //if(n == null ) return n.key;
        while(n.left != null)
            n = n.left;
        return n;
    }
    public <K> BinaryTreeNode maximum(){
        if(root!=null)
            return maximum(root);
        else throw new IllegalArgumentException("空树");
    }
    private <K> BinaryTreeNode maximum(BinaryTreeNode n){
        //if(n == null ) return n.key;
        while(n.right != null)
            n = n.right;
        return n;
    ...
    private BinaryTreeNode removeMin(BinaryTreeNode n){
        if(n.left==null){
    ...
    private BinaryTreeNode removeMax(BinaryTreeNode n){
        if(n.right==null){
    ...
    private <K extends Comparable> BinaryTreeNode remove(BinaryTreeNode n, K key){
        ...
        if(key.compareTo(n.key) > 0) {
            ...
            * */
            //方法一：
            /*BinaryTreeNode successor = new BinaryTreeNode(maximum(n.right));
            successor.right = removeMin(n.right);
            successor.left = n.left;
            return successor;*/
            //方法二
            BinaryTreeNode precursor = new BinaryTreeNode(minimum(n.left));
